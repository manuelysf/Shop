...
/// Load products from JSON and append to shop content
function loadProducts() {
  fetch('/produkte/produkteData')
    .then(response => {
      if (!response.ok) {
    ...
    .then(products => {
      ...
      // Call ready function after products are loaded (assuming it exists)
...
// Ready function to set up cart functionality
function ready() {
...
function addProductToCart(title, price, productImg) {
  ...
  // Event listeners for the new cart item
  cartShopBox
